function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'soundtrack',loop:true,volume:0.3, ingamename: 'soundtrack'});
        s_aSoundsInfo.push({path: './sounds/',filename:'click',loop:false,volume:0.6, ingamename: 'click'});
        s_aSoundsInfo.push({path: './sounds/',filename:'game_over',loop:false,volume:0.6, ingamename: 'game_over'});
        s_aSoundsInfo.push({path: './sounds/',filename:'card_dealing',loop:false,volume:0.6, ingamename: 'card_dealing'});
        s_aSoundsInfo.push({path: './sounds/',filename:'snap',loop:false,volume:0.6, ingamename: 'snap'});
        s_aSoundsInfo.push({path: './sounds/',filename:'card',loop:false,volume:0.6, ingamename: 'card'});
        s_aSoundsInfo.push({path: './sounds/',filename:'special_card',loop:false,volume:0.6, ingamename: 'special_card'});
        s_aSoundsInfo.push({path: './sounds/',filename:'change_color',loop:false,volume:0.6, ingamename: 'change_color'});
    ...
    this._loadImages = function(){
        ...
        s_oSpriteLibrary.addSprite("but_one","./sprites/but_one.png");
    ...
    this.onRemovePreloader = function (){
        ...
        s_oSoundtrack = playSound("soundtrack",0.3,true);
